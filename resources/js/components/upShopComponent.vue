    ...
    <el-row >
        ...
        <el-col :span="24">
            <el-breadcrumb separator-class="el-icon-arrow-right">
                ...
                <el-breadcrumb-item><a v-bind:href="myshop">我的店</a></el-breadcrumb-item>
                <el-breadcrumb-item>修改店铺</el-breadcrumb-item>
            </el-breadcrumb>
        </el-col>
    ...
    export default {
        ...
        methods: {
            ...
            resetForm(formName) {
                ...
                let this_=this;
                console.log(this_);
                axios.get(this.shopinfo).then(function (response) {
                    if(response.data.code=='200'){
